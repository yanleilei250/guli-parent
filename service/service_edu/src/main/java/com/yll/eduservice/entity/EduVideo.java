...
public class EduVideo implements Serializable {
    ...
    public EduVideo(String id, String courseId, String chapterId, String title, String videoSourceId, String videoOriginalName, Integer sort, Long playCount, Boolean isFree, Float duration, String status, Long size, Long version, Date gmtCreate, Date gmtModified) {
        this.id = id;
        this.courseId = courseId;
        this.chapterId = chapterId;
        this.title = title;
